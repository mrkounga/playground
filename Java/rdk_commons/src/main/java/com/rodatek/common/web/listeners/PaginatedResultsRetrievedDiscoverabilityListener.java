package com.rodatek.common.web.listeners;
...
import com.rodatek.common.web.util.LinkUtil;


import com.google.common.base.Preconditions;
import com.google.common.net.HttpHeaders;
import com.rodatek.common.search.ClientOperation;
import com.rodatek.common.web.IUriMapper;
...
class PaginatedResultsRetrievedDiscoverabilityListener implements ApplicationListener<PaginatedResultsRetrievedEvent> {
    ...
    protected void plural(final UriComponentsBuilder uriBuilder, final Class clazz) {
        ...
        uriBuilder.path(WebConstants.PATH_SEP + resourceName);
    }
