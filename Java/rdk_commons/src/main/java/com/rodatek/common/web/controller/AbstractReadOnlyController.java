...
import com.rodatek.common.persistence.service.IRawService;
import com.rodatek.common.util.QueryConstants;
import com.rodatek.common.web.RestPreconditions;
import com.rodatek.common.web.WebConstants;
import com.rodatek.common.web.events.MultipleResourcesRetrievedEvent;
import com.rodatek.common.web.events.PaginatedResultsRetrievedEvent;
import com.rodatek.common.web.events.SingleResourceRetrievedEvent;
import com.rodatek.common.web.exception.MyResourceNotFoundException;
...
public abstract class AbstractReadOnlyController<T extends IWithName> {
    ...
    protected final List<T> findAllSortedInternal(final String sortBy, final String sortOrder) {
    	System.out.println("findAllSortedInternal : sortBy ="+sortBy+ "and sortOrder="+sortOrder);
